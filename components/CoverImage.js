...
import { chooseImage, handleUpload, fetchLogo, delData } from '../controllers/coverImages'
            ...
            <AccordionItemHeading>
                <AccordionItemButton>
                    <div className={styles.ques}>
                        ...
                        <div className={styles.questxt}>Cover Images </div>
                    </div>
                </AccordionItemButton>
            </AccordionItemHeading>
            <AccordionItemPanel>
                <div className={styles.cont}>
                    <div className={styles.title}>Add Cover Image</div>
                    <div className={styles.logobox}>
                        <div className={styles.sub}>
                            JPEG, PNG, or JPG. Recommended width: 512 pixels minimum and should be a sqaure. max(4)
                        </div>
                        {imageurl ? (
                        ...
                        <div className={styles.logocontainer}>
                            ...
                            {imageData && imageData.length < 1 ? <div className={styles.tell}>No Cover Images Uploaded yet </div> : null}

                            {imageData && imageData.map((item, i) => (
                                <div key={i} className={styles.imagelogoboxcontainer}>
                                    <div id={styles.coverImagebox} style={{width:200}} className={styles.imagelogobebox}>
                                        <Image id={styles.coverImage}  className={styles.logoimage} width={200} height={100} blurDataURL={item.image} src={item.image} placeholder="blur" alt="logo" />
                                    </div>
