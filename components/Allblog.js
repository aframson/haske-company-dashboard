...
import { fetchBlogs, delData } from '../controllers/blog'
...
export default function AllBlog({ setIsProduct, setLoad, type }) {
  ...
  useEffect(() => {
    fetchBlogs(setGiftCard, setLoading, setAdd, errMsg, setIsProduct, setLoad, type)
    ...
    <div className={styles.tablerow}>
      <div className={styles.tablecontent}>
        <div className={styles.tablehead}>
          <div className={styles.th}>Blog</div>
          <div className={styles.th}>staus</div>
          <div className={styles.th}>Author</div>
        ...
        {giftCardData && giftCardData.map((item, i) => (
          <div key={i} className={styles.body}>
            ...
            <div className={styles.tb}>{item.author}</div>
