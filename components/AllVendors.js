...
import { fetchVendors, delData } from '../controllers/vendors'
...
export default function AllVendors({ setIsProduct, setLoad, type }) {
  ...
  useEffect(() => {
    fetchVendors(setCollection, setLoading, setAdd, errMsg, setIsProduct, setLoad, type)
    ...
    <div className={styles.tablerow}>
      <div className={styles.tablecontent}>
        <div className={styles.tablehead}>
          <div className={styles.th}>Vendors</div>
        ...
        {collectionData && collectionData.map((item, i) => (
          <div key={i} className={styles.body}>
            ...
            <div className={styles.tb}>
              <div className={styles.stats}>{item.ownername}</div>
            </div>
