...
const addLogo = async (filename, downloadURL, setMsg, errMsg, setLoading, setImageUrl, setProgress) => {
    setLoading(true)
    try {
...
export const handleUpload = async (filename, setLoading, imageLocation, setProgress, setMsg, errMsg, setImageUrl) => {
    ...
    uploadTask.on('state_changed', (snapshot) => {
        ...
        getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
            ...
            addLogo(filename, downloadURL, setMsg, errMsg, setLoading, setImageUrl, setProgress);
        });
        setLoading(false)
    });
