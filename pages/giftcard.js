...
import { fetchGiftCards } from '../controllers/giftcard';
function GiftCard() {
    ...
    useEffect(() => {
        fetchGiftCards(setGetProducts, setLoading, setAdd, errMsg, setIsProduct, setLoading, tabs)
        ...
        <NavigationLayout>
            <ViewLayout title={"GiftCards"}>
                <NicheCard id={styles.prodbox}>
                    ...
                    {tabs === 'active' ? (
                        <AllgiftCards type={tabs} setLoad={setLoading} setIsProduct={setIsProduct} />
                    ) : null}
                    {tabs === 'draft' ? (
                        <AllgiftCards type={tabs} setLoad={setLoading} setIsProduct={setIsProduct} />
                    ) : null}
